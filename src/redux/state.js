...
// создаем наблюдателя (который получает некий параметр), експортируем его (в файл index.js)
//в index.js вызываем и передаем параметром функцию reRender (subscribe(reRender);)
